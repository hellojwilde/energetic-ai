...
export default function HomepagePerformance(): JSX.Element {
  ...
  return (
    <section className={styles.perfSection}>
      <div className="container">
        <h2 className={styles.perfHeading}>Performance</h2>
        <p className={styles.perfSubheading}>
          Optimized for serverless functions, EnergeticAI maximizes cold-start
          speed while minimizing module size.
        </p>
